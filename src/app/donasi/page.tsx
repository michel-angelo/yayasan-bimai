      ...
      {step === 3 && (
        <div className="space-y-6">
          ...
          <div className="bg-[#fdfaf5] border border-amber-200/60 p-4 rounded-xl text-xs text-gray-600 space-y-1">
            ...
            <p>
              Dengan mengklik &quot;Bayar Sekarang&quot;, Anda akan mendapatkan kode pembayaran resmi terenkripsi untuk menyelesaikan transaksi wakaf Anda.
            </p>
          </div>
      ...
      <Suspense
        fallback={
          <div className="max-w-2xl mx-auto bg-white p-8 border border-gray-100 rounded-3xl shadow-sm text-center">
            <p className="text-sm text-gray-500 animate-pulse">Memuat formulir donasi...</p>
          </div>
        }
      >
        <DonasiFormContent />
